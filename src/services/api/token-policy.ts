...
export const routes: FastifyPluginAsync<{ Core: ICore }> = async function routes(server, { Core }) {
  ...
  server.put<{
    ...
    '/refile/:id/token-policies/write-token-required'
  , {
      schema: {
        params: { id: idSchema }
      , body: { type: 'boolean' }
  ...
  server.put<{
    ...
    '/refile/:id/token-policies/read-token-required'
  , {
      schema: {
        params: { id: idSchema }
      , body: { type: 'boolean' }
  ...
  server.put<{
    ...
    '/refile/:id/token-policies/delete-token-required'
  , {
      schema: {
        params: { id: idSchema }
      , body: { type: 'boolean' }
