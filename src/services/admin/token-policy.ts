...
export const routes: FastifyPluginAsync<{ api: IAPI }> = async (server, { api }) => {
  ...
  server.get<{
    ...
    '/refile/:namespace/token-policies'
  , {
      schema: {
  ...
  server.put<{
    ...
    '/refile/:namespace/token-policies/write-token-required'
  , {
      schema: {
        params: { namespace: namespaceSchema }
      , body: { type: 'boolean' }
  ...
  server.put<{
    ...
    '/refile/:namespace/token-policies/read-token-required'
  , {
      schema: {
        params: { namespace: namespaceSchema }
      , body: { type: 'boolean' }
  ...
  server.put<{
    ...
    '/refile/:namespace/token-policies/delete-token-required'
  , {
      schema: {
        params: { namespace: namespaceSchema }
      , body: { type: 'boolean' }
